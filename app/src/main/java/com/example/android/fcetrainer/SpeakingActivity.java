...
public class SpeakingActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        speakingParts.add(new Paper("4", "discussion", "a discussion topic related to part 3", "the focus is expressing and justify opinion", "not specific", "see speaking scale", "see speaking scale", "4 minutes"));
